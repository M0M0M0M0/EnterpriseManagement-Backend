...
builder.Services.AddScoped<IApprovalDelegationResolver, ApprovalDelegationResolver>();
...
builder.Services.AddScoped<IKpiPlanRepository, KpiPlanRepository>();
builder.Services.AddScoped<IKpiPlanService, KpiPlanService>();
builder.Services.AddScoped<ISalesCommissionRepository, SalesCommissionRepository>();
builder.Services.AddScoped<ISalesCommissionService, SalesCommissionService>();
