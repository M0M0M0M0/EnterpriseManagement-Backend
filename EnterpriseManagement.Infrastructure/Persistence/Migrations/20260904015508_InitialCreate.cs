        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveTypeCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    LeaveTypeName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DefaultDays = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_WorkShifts_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KpiTargetId = table.Column<long>(type: "bigint", nullable: false),
                    CommissionRate = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesCommissions_Employees_ApprovedBy",
                        column: x => x.ApprovedBy,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalesCommissions_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceAdjustments_ApprovedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceAdjustments_RequestedBy",
                table: "AttendanceAdjustments",
                column: "RequestedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveTypes_LeaveTypeCode",
                table: "LeaveTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesCommissions_EmployeeId",
                table: "SalesCommissions",
                column: "EmployeeId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AttendanceAdjustments_AttendanceRecords_AttendanceId",
                table: "AttendanceAdjustments",
                column: "AttendanceId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AttendanceAdjustments_Employees_ApprovedBy",
                table: "AttendanceAdjustments",
                column: "ApprovedBy",
                principalTable: "Employees",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AttendanceAdjustments_Employees_RequestedBy",
                table: "AttendanceAdjustments",
                column: "RequestedBy",
                principalTable: "Employees",
                principalColumn: "Id",
